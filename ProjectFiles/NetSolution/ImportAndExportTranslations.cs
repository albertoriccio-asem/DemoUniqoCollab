...
public class ImportAndExportTranslations : BaseNetLogic
{
    ...
    private IUAVariable GetDictionary()
    {
        ...
        if (resultDictionaryVariable == null || !resultDictionaryVariable.IsInstanceOf(QPlatform.Core.VariableTypes.LocalizationDictionary))
    ...
    {
        var localizationDictionaryType = Project.Current.Context.GetNode(QPlatform.Core.VariableTypes.LocalizationDictionary);
